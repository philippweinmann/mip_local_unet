...
def get_appropriate_dice_weight(amt_positive_voxels, max_dice_threshold):
...
def calculate_learning_rate(amt_positive_voxels, epoch):
    ...
    lr = 0.8 ** (epoch) * 0.03 * np.log10(amt_positive_voxels + 1.05)
